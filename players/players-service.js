/**
 * Service generates players record and broadcast them to all connected clients.
 * Clients connected via WS.
 * Stop generation if no more clients connected.
 */
import {playersGenerator} from './players-generator.js';
